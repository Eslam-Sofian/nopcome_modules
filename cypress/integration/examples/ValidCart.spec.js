...
describe('CartPage', function () {
   ...
   cy.get('#shopping-cart-form > div.table-wrapper > table > tbody > tr > td.remove-from-cart > input').check()
   cy.get('.update-cart-button').click()
   cy.get(' div.page-body > div > div').contains('Your Shopping Cart is empty!')
   })
   it('AddToCart', () => {
    cy.visit('https://demo.nopcommerce.com/')
   ...
   cy.get('#topcartlink').should('be.visible').click()
   cy.get('#shopping-cart-form > div.table-wrapper > table > tbody > tr >td.quantity > input').should('have.value','1')
   cy.get('#shopping-cart-form > div.table-wrapper > table > tbody > tr > td.unit-price > span').contains('$245.00')
   cy.get('#shopping-cart-form > div.table-wrapper > table > tbody > tr >td.quantity > input').clear().type('2')
   cy.get('#shopping-cart-form > div.table-wrapper > table > tbody > tr > td.unit-price > span').contains('$490.00')
